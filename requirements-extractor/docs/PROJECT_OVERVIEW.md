...
python3 -m unittest discover tests                 # should report ~427 passing
```

As of end of 2026-04-24 the baseline is **427 tests passing, 0
...
- `python3 -m py_compile requirements_extractor/*.py` to confirm
  syntax is clean.
- `python3 -m unittest discover tests` to confirm the 427-test
  baseline.
